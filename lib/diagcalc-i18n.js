(function (root, factory) {
  ...
  const translations = {
    en: {
      ...
      "library.help": "Values are filled in automatically and can be adjusted afterwards.",
      "editor.kicker": "Editor",
      "editor.h": "Build the confusion matrix",
      "editor.help": "Use non-negative integers and a pre-test probability under 100%.",
    ...
    "pt-PT": {
      ...
      "library.help": "Os valores são preenchidos automaticamente e podem ser ajustados depois.",
      "editor.kicker": "Editor",
      "editor.h": "Construir a matriz de confusão",
      "editor.help": "Use inteiros não-negativos e uma probabilidade pré-teste abaixo de 100%.",
